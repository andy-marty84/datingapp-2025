...
public class AccountController(UserManager<AppUser> userManager, ITokenService tokenService) : BaseApiController
{
    ...
    {
        // In reality you don't want to let them know whether it failed on email or password
    ...
    private async Task SetRefreshTokenCookie(AppUser user)
    {
        ...
        {
            HttpOnly = true, // not accessible from any kind of JS including our own client app
            Secure = true,
