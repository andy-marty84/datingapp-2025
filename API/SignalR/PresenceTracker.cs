...
{
    private static readonly ConcurrentDictionary<string, ConcurrentDictionary<string, byte>> OnlineUsers = new(); // first string is userId, then the inner concurrent dictionary are the connections (byte is meaningless data here)
