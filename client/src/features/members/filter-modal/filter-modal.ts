...
export class FilterModal {
  ...
  closeModal = output(); // No type as we don't need to emit anything here
  ...
  openModal() {
    this.modalRef.nativeElement.showModal(); // Nothing angular about this
  }

  close() {
    this.modalRef.nativeElement.close();
    this.closeModal.emit(); // Just signals to parent that this modal has closed
  }
